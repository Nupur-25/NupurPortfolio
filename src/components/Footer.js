      ...
      <Container>
        <Row className="align-items-center">
          ...
          <div className="social-icon">
                <a href="https://www.linkedin.com/in/nupur-ghosh-315131251" target="_blank" rel="noopener noreferrer"><img src={navIcon1} alt="" /></a> 
                 <div className="social-icon">
                  <a href="https://github.com/Nupur-25" target="_blank" rel="noopener noreferrer">
                    <svg
                      width="16"
                      height="16"
                      viewBox="0 0 16 16"
